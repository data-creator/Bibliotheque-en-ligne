...
include 'conex/db.php';

if (isset($_POST["save"])) 
      {
        extract($_POST);

        if (!empty($_POST["id_p"]) && !empty($_POST["nom"]) && !empty($_POST["pronrm"]) && !empty($_POST["date"])&& !empty($_POST["password"]) && !empty($_POST["email"]) && !empty($_POST["tel"])
          && !empty($_POST["groupe"]))
        {
          $nom=$_POST["nom"];
          $prenom=$_POST["prenom"];
          ...
          $search=$cnx->prepare("insert into client (`nom`, `prenom`, `tel`, `adresse`, `codepostal`, `email`, `password`) VALUES (:nom,:prenom,:phone,:adress,:codpostal,:email,:password)");
          $search->bindParam(':nom', $nom);
          $search->bindParam(':prenom', $prenom);
          $search->bindParam(':phone', $phone);
          $search->bindParam(':adress', $adress);
          $search->bindParam(':codpostal', $codpostal);
...
<body>
  ...
  <section id="container" class="">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="ajouterlivre.php">ajouter livre</a></li>
              <li><a class="" href="modifierlivre.php">modifier livre</a></li>
            </ul>
          </li>
    <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
              <li><a class="" href="ajouteretudiant.php">ajouter etudiant </a></li>
              <li><a class="" href="modifieretudiant.php">modifier etudiant</a></li>
            </ul>
          </li>
    ...
    <li class="sub-menu">
            <a href="javascript:;" class="">
                          <i class="icon_document_alt"></i>
                          <span>gestion prof</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
            <ul class="sub">
              <li><a class="" href="ajouterprofesseur.php">ajouter</a></li>
              <li><a class="" href="modifierprofesseur.php">modifier</a></li>
            </ul>
          </li>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="get" action="" novalidate="novalidate">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Identifion professeur <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="id_p" name="id_p" type="id">
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      <label for="password" class="control-label col-lg-2">Date <span class="required">*</span></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <button class="btn btn-default" type="button" name="cancel">Cancel</button>
                      </div>
                    </div>
                  </form>
                </div>
