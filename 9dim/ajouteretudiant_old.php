                ...
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="get" action="" novalidate="novalidate">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Identifion etudiant <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="id_e" name="id_e" type="id">
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                     ...
                     <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class=" form-control" id="groupe" name="groupe" type="groupe">
                      </div>
