    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
...

        {
          ...
          $id=$_GET["id"];
           ...
           $search=$cnx->prepare("UPDATE `livre` SET `nom_li`=:nom_li,`nom_auteur`=:nom_auteur,`nbr_exempl`=:nbr_exempl,`id_ca`=:id_ca ,`image`=:image WHERE id_li=:id");
    ...
    <input  class="form-control " type="file" name="fileToUpload" id="fileToUpload">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        <button class="btn btn-primary" type="submit" name="save"href="?page=modifier_livre">Save</button>
